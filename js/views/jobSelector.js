...
function bindJobSelector(container, jobs) {
  ...
  container.querySelectorAll('.job-selector-note-content').forEach(button => button.addEventListener('click', () => editEntryNote(container, jobs, button.dataset.entryId, button)));
