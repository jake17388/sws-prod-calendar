...
export const DEPARTMENTS = ['Admin', 'Manager', 'Viewer', 'Manufacturing', 'Graphics', 'Routing', 'Paint', 'Letters', 'Assembly'];
...
export const JOB_DEPARTMENTS = ['Manufacturing', 'Graphics', 'Routing', 'Paint', 'Letters', 'Assembly'];
